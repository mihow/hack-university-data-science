...
class Session():
    ...
    def fetch(begin, end, filters = {"logical": "and", "conditions": []}):
    ...
    def routes_for_day(route_number, first_stop, last_stop, date, save=True):
        ...
        for situation, filters in situations.items():
            resp = fetch(start_time, end_time, filters)
...
if __name__ == "__main__":
    ...
    session = Session()
    session.routes_since_august(19, 1545, 792, debug=False)
